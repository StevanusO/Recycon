...
<?php $__env->startSection('webiste-title', 'Home Page (Guest)'); ?>    
                    ...
                    <div class="sub-content-mid d-flex container-horizontal gap-4 py-3">
                        <div class="card bg-warning" style="width: 20rem;">
                            <div class="card-body">
                              ...
                              <p class="card-text">We have a thousand of recycle and secondhand things product that all of them are in good condition</p>
                            </div>
                        </div>
                        ...
                        <div class="card bg-success text-light" style="width: 20rem;">
                            <div class="card-body">
                              ...
                              <p class="card-text">Our operational time are from monday to saturdary which is from 08:00 - 17:00</p>
                            </div>
                        </div>
                        <div class="card bg-dark text-light" style="width: 20rem;">
                            <div class="card-body">
                              <h5 class="card-title">Customer Service</h5>
                              <p class="card-text">We have tgood staffs that ready to solve your problem anytime.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('website_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\BINUS5\WEB_PROG\PROJECT_LAB\Website\resources\views/home_guest.blade.php ENDPATH**/ ?>